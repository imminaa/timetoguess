  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      <input
        ...
        className="h-12 w-full rounded-xl border border-line bg-surface pl-11 pr-11 text-[15px] text-ink placeholder:text-faint outline-none transition-colors duration-200 focus:border-accent/60 focus:bg-surface-2 disabled:cursor-not-allowed disabled:opacity-50"
      />
      {loading && (
        <CircleNotch
          size={18}
      ...
      {open && (
        <ul
          ...
          className="absolute inset-x-0 top-full z-20 mt-2 max-h-72 animate-fade-up overflow-y-auto rounded-xl border border-line bg-surface-2 shadow-[0_24px_60px_-16px_rgba(0,0,0,0.7)] [animation-duration:200ms]"
        >
